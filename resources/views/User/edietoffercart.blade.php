                ...
                <div style="background-color: none; margin-top:150px" class="panel-body">
                    <div class="col-md-6">
                        ...
                        <div style="margin-top: 25px;" class="pro-img-details">
                            <img src="{{ asset('/upload/Adminimage/productsImageFolder/'.$product->image) }}" style="width: 500px;height:400px" class="thumbnail" style="width: 250px;height:290px; margin-top:-47px" alt="new-arrivals images">
                        </div>
                        
                    </div>
                    <div class="col-md-6">
                        <h4 class="pro-d-title">
                            <a href="{{url('productdetails/'.$product->id)}}" class="">
                                {{$product->name}}
                            </a>
                        </h4>
                        <p>
                            ...
                            @endforeach
                                ...
                                <form method="POST" action="{{url('update_cart/'.$cart->id)}}">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" id="quantity" value="{{$cart->prod_qty}}" name="qty" class="form-control quantity" />
