						...
						@foreach ($search as $item)
							<div style="margin-top: 30px" class="col-sm-3 ">
								<div class="single-feature">
									<img src="{{ asset('/upload/Adminimage/productsImageFolder/'.$item->image) }}" class="thumbnail" style="width: 250px;height:290px; margin-top:-47px" alt="new-arrivals images">
									<div class="single-feature-txt text-center">
										...
										<a style="font-size: 30px;" href="{{url('productdetails/'.$item->id)}}"><h1 > {{$item->name}} </h1></a>
										<h3><a href="{{url('getcategory/'.$item->category->slug)}}">{{$item->category->name}}</a></h3>
