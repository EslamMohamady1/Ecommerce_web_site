                        ...
                        @foreach ($products as $item)
                            <div class="col-md-3 col-sm-4">
                                <div class="single-new-arrival">
                                    ...
                                    <h4><a href="{{url('productdetails/'.$item->id)}}">{{$item->name}}</a></h4>
                                    <h6><a href="{{url('getcategory/'.$item->category->slug)}}">{{$item->category->name}}</a></h6>
				...
				<div class="feature-content">
					<div class="row">
						@foreach ($offers as $offers)
							<div class="col-sm-3">
								<a href="{{url('offerdetails/'.$offers->id)}}">
								<div class="single-feature">
									<img src="upload\Adminimage\productsImageFolder\{{$offers->image}}" alt="feature image">
									<div class="single-feature-txt text-center">
										<p>
											...
											<h3>{{$offers->category->name}}</h3>
										</p>
										<h3><a href="{{url('getcategory/'.$item->category->slug)}}">{{$offers->name}}</a></h3>
										<h5>{{$offers->selling_price}}</h5>
									</div>
								</div>
								</a>
							</div>
