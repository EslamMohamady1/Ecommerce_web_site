          ...
          <table class="table align-items-center justify-content-center mb-0">
            <thead>
              <tr>
                ...
                <th class="text-uppercase text-secondary text-xxs font-weight-bolder text-center opacity-7 ps-2">Category Image</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <span class="text-xs font-weight-bold">{{$category->slug}}</span>
                </td>
                <td>
                  <span class="text-xs font-weight-bold">{{$category->description}}</span>
                </td>
                <td>
                ...
                <td class="align-middle text-center">
                  <div class="d-flex align-items-center justify-content-center">
                    <span class="me-2 text-xs font-weight-bold">{{$category->description}}</span>
                    <div>
                      <div class="progress">
